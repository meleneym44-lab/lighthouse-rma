        ...
        const contactRes = await fetch(`${B2B_API_URL}/accounts/${B2B_ACCOUNT_ID}/contacts`, {
          ...
          body: JSON.stringify({
            contact: {
              ...
              is_client: true,
              is_provider: false,
              name: payload.contact_name || 'Test Client SARL',
              tin_value: payload.contact_tin || 'FR12345678901',
              tin_scheme: '9957',
              country: 'fr',
              email: payload.contact_email || 'test@example.com',
              address: payload.contact_address || '1 Rue de Test',
              postalcode: payload.contact_postal || '75001',
              city: payload.contact_city || 'Paris',
